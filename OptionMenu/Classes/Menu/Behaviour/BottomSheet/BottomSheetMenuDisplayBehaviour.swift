...
//        if isLandscape {
//
//            doLandscape(size: CGSize(width: screenWidth, height: CGFloat.greatestFiniteMagnitude))
//
//        } else {
//
//            doPortrait(size: CGSize(width: screenWidth, height: 0))
//        }
...
extension BottomSheetMenuDisplayBehaviour {
    ...
    static var initialSize : CGSize {
        ...
        return BottomSheetMenuDisplayBehaviour.preferredSize(isLandscape: isLandscape, screenWidth: UIScreen.main.bounds.width)
    }
    ...
    private func initOrientationObserver() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(orientationDidChange(notification:)), name: Notification.Name(rawValue: "OrientationChanged"), object: nil)
        
    }
    
    private func removeObserver() {
        
        NotificationCenter.default.removeObserver(self, name: Notification.Name(rawValue: "OrientationChanged"), object: nil)
    ...
    @objc private func orientationDidChange(notification: Notification){
        ...
        if let userInfo = notification.userInfo,
            ...
            let preferedSize = BottomSheetMenuDisplayBehaviour.preferredSize(isLandscape: isLandscape, screenWidth: size.width)
...
extension BottomSheetMenuDisplayBehaviour : OptionsMenuDisplayBehaviour {
    ...
    public func display(_ optionsMenu: OptionsMenu, animated: Bool = true) {
        ...
        optionsMenu.parentViewController.present(self.bottomSheetViewController, animated: animated, completion: nil)
